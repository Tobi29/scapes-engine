...
public abstract class CoroutineDispatcher :
     ...
     */
    public abstract fun dispatch(context: CoroutineContext,
                                 block: Runnable)
    ...
    override fun toString(): String =
            "${this::class.java.simpleName}@${Integer.toHexString(
    ...
    override fun run() {
        ...
        when {
            job != null && job.isCompleted ->
                dispatched.resumeUndispatchedWithException(
                        job.getCompletionException())
            exception -> dispatched.resumeUndispatchedWithException(
                    value as Throwable)
...
header internal class DispatchedContinuation<in T>(
    ...
    internal fun dispatchYield(job: Job?,
                               value: T)
}
