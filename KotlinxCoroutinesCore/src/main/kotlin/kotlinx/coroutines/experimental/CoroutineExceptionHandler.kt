 ...
 */
header fun handleCoroutineException(context: CoroutineContext,
                                    exception: Throwable)
...
public interface CoroutineExceptionHandler : CoroutineContext.Element {
    ...
    companion object Key : CoroutineContext.Key<CoroutineExceptionHandler> {
        ...
        public operator inline fun invoke(crossinline handler: (CoroutineContext, Throwable) -> Unit): CoroutineExceptionHandler =
                object : AbstractCoroutineContextElement(
                        Key), CoroutineExceptionHandler {
     ...
     */
    public fun handleException(context: CoroutineContext,
                               exception: Throwable)
}
