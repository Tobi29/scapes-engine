...
public interface CancellableContinuation<in T> : Continuation<T>, Job {
     ...
     */
    public fun tryResume(value: T,
                         idempotent: Any? = null): Any?
...
@PublishedApi
header internal open class CancellableContinuationImpl<in T>(
        delegate: Continuation<T>,
        defaultResumeMode: Int,
        active: Boolean
    ...
    override fun tryResume(value: T,
                           idempotent: Any?): Any?
