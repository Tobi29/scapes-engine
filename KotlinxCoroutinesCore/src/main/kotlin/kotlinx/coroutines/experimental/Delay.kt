...
public interface Delay {
    ...
    suspend fun delay(time: Long,
        ...
        return suspendCancellableCoroutine {
            scheduleResumeAfterDelay(time, unit, it)
        }
    }
     ...
     * ```
     */
    fun scheduleResumeAfterDelay(time: Long,
                                 unit: TimeUnit,
     ...
     */
    fun invokeOnTimeout(time: Long,
                        unit: TimeUnit,
                        block: Runnable): DisposableHandle =
            scheduleDisposable(block, time, unit)
}
    ...
    return suspendCancellableCoroutine sc@ { cont: CancellableContinuation<Unit> ->
        ...
        if (delay != null)
            ...
            cont.disposeOnCompletion(
                    scheduleDisposable(ResumeRunnable(cont), time, unit))
    }
}
