...
public class Mesh {
    ...
    public Model finish(ScapesEngine engine) {
        ...
        if (triangles) {
            Model model;
            if (color) {
                model = VAOUtility.createVCTN(engine, vertexArray, colorArray,
                        textureArray, normalArray, RenderType.TRIANGLES);
            } else {
                model = VAOUtility.createVTN(engine, vertexArray, textureArray,
            ...
            Model model;
            if (color) {
                model = VAOUtility.createVCTNI(engine, vertexArray, colorArray,
                        textureArray, normalArray, indexArray,
                        RenderType.TRIANGLES);
            } else {
                model = VAOUtility.createVTNI(engine, vertexArray, textureArray,
