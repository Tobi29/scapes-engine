...
class GuiComponentSlider constructor(parent: GuiLayoutData, textSize: Int, text: String,
                                     private var value: Double, textFilter: (String, Double) -> String = { text1, value1 -> text1 + ": " + (value1 * 100).toInt() + '%' }) : GuiComponentSlab(
        parent) {
