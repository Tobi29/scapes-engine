...
internal fun stringImpl(
    ...
    val digits = Op128Tables.digitsInLong[radix - 2]
    val radixToPower = Op128Tables.powerInLong[radix - 2].toUInt128()
    var ah = ah
    var al = al
    var result = ""
