...
public interface SendChannel<in E> {
     ...
     */
    public fun <R> registerSelectSend(select: SelectInstance<R>,
                                      element: E,
                                      block: suspend () -> R)
...
public interface ReceiveChannel<out E> {
     ...
     * @suppress **This is unstable API and it is subject to change.**
     */
    public fun <R> registerSelectReceive(select: SelectInstance<R>,
                                         block: suspend (E) -> R)
     ...
     * @suppress **This is unstable API and it is subject to change.**
     */
    public fun <R> registerSelectReceiveOrNull(select: SelectInstance<R>,
                                               block: suspend (E?) -> R)
}
 ...
 */
// TODO
public class ClosedSendChannelException(message: String?) : java.util.concurrent.CancellationException(
        message)
 ...
 */
public class ClosedReceiveChannelException(message: String?) : NoSuchElementException(
        message)
