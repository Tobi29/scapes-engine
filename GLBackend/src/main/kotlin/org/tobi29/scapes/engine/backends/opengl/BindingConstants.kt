...
expect val GL_STACK_OVERFLOW: GLEnum
expect val GL_STACK_UNDERFLOW: GLEnum
expect val GL_OUT_OF_MEMORY: GLEnum
expect val GL_INVALID_FRAMEBUFFER_OPERATION: GLEnum
expect val GL_TABLE_TOO_LARGE: GLEnum
