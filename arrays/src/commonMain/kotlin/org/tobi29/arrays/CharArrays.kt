 ...
 * @return Return value of [block]
 */
inline fun <R> Chars.mutateAsCharArray(block: (CharArray, Int, Int, () -> Unit) -> R): R {
    val array: CharArray
    val offset: Int
...
inline fun <R> Chars.mutateAsCharArray(block: (CharArray, Int, Int) -> R): R =
    mutateAsCharArray { array, offset, size, close ->
        try {
