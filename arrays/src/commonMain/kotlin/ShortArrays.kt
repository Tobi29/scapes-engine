 ...
 * @return Return value of [block]
 */
inline fun <R> Shorts.mutateAsShortArray(block: (ShortArray, Int, Int, () -> Unit) -> R): R {
    val array: ShortArray
    val offset: Int
...
inline fun <R> Shorts.mutateAsShortArray(block: (ShortArray, Int, Int) -> R): R =
    mutateAsShortArray { array, offset, size, close ->
        try {
