 ...
 * @return Return value of [block]
 */
inline fun <R> Booleans.mutateAsBooleanArray(block: (BooleanArray, Int, Int, () -> Unit) -> R): R {
    val array: BooleanArray
    val offset: Int
...
inline fun <R> Booleans.mutateAsBooleanArray(block: (BooleanArray, Int, Int) -> R): R =
    mutateAsBooleanArray { array, offset, size, close ->
        try {
 ...
 */
inline fun BooleanArray.indices(block: (Int) -> Unit) {
    for (x in indices) {
        block(x)
    }
}
 ...
 * Fills the given array with values
 */
inline fun Booleans.fill(supplier: (Int) -> Boolean) =
    indices { x -> this[x] = supplier(x) }

/**
 * Fills the given array with values
 */
inline fun BooleanArray2.fill(supplier: (Int, Int) -> Boolean) =
    indices { x, y -> this[x, y] = supplier(x, y) }

/**
 * Fills the given array with values
 */
inline fun BooleanArray3.fill(supplier: (Int, Int, Int) -> Boolean) =
 ...
 */
inline fun BooleanArray.change(
    index1: Int,
 ...
 * **Note:** This operation is not atomic
 */
inline fun BooleanArray2.change(
 ...
 * **Note:** This operation is not atomic
 */
inline fun BooleanArray3.change(
