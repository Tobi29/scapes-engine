...
public final class PlatformDialogs {
    private static final Logger LOGGER =
            LoggerFactory.getLogger(PlatformDialogs.class);
    ...
    public static void openFileDialog(long window,
            Pair<String, String>[] extensions, boolean multiple,
    ...
    public static Optional<FilePath> saveFileDialog(long window,
            Pair<String, String>[] extensions) {
        if (window != 0) {
            GLFW.glfwIconifyWindow(window);
        }
        try {
    ...
    public static void openFile(FilePath path) {
        String[] command;
