...
public class QtBackendProvider implements ScapesEngineBackendProvider {
    ...
    public Container createContainer(ScapesEngine engine) {
        QApplication.initialize(engine.game().name(), EMPTY_STRING);
        return new ContainerQWidget(engine);
    }
}
