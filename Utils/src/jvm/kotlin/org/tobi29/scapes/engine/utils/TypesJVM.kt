...
typealias WeakHashMap<K, V> = java.util.WeakHashMap<K, V>
...
inline fun <E> ConcurrentHashSet(): MutableSet<E> =
        java.util.Collections.newSetFromMap(ConcurrentHashMap<E, Boolean>())
