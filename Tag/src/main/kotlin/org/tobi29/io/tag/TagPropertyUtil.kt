 ...
 */
fun MutableTagMap.tagBoolean(key: String, default: Boolean) =
 ...
 * @return An object for property delegation
 */
fun MutableTagMap.tagByte(key: String, default: Byte) =
 ...
 * @return An object for property delegation
 */
fun MutableTagMap.tagShort(key: String, default: Short) =
 ...
 * @return An object for property delegation
 */
fun MutableTagMap.tagInt(key: String, default: Int) =
 ...
 * @return An object for property delegation
 */
fun MutableTagMap.tagLong(key: String, default: Long) =
 ...
 * @return An object for property delegation
 */
fun MutableTagMap.tagFloat(key: String, default: Float) =
 ...
 * @return An object for property delegation
 */
fun MutableTagMap.tagDouble(key: String, default: Double) =
 ...
 * @return An object for property delegation
 */
fun MutableTagMap.tagByteArray(key: String, default: ByteArray) =
 ...
 * @return An object for property delegation
 */
fun MutableTagMap.tagString(key: String, default: String) =
