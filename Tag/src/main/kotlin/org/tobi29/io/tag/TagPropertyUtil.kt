...
inline fun tagBoolean(key: String,
        ...
        tag(key,
                { it?.toBoolean() ?: default }, Boolean::toTag, access)
...
inline fun tagShort(key: String,
                    ...
                    crossinline access: () -> MutableTagMap) =
        tag(key,
                { it?.toShort() ?: default }, Short::toTag, access)
...
inline fun tagFloat(key: String,
                    ...
                    crossinline access: () -> MutableTagMap) =
        tag(key,
                { it?.toFloat() ?: default }, Float::toTag, access)
...
inline fun tagDouble(key: String,
                     ...
                     crossinline access: () -> MutableTagMap) =
        tag(key,
                { it?.toDouble() ?: default }, Double::toTag, access)
...
inline fun tagByteArray(key: String,
                        ...
                        crossinline access: () -> MutableTagMap) =
        tag(key,
                { it?.toByteArray() ?: default }, ByteArray::toTag, access)
...
inline fun tagString(key: String,
                     ...
                     crossinline access: () -> MutableTagMap) =
        tag(key,
                { it?.toString() ?: default }, String::toTag, access)
