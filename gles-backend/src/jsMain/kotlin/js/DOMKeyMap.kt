...
object DOMKeyMap {
    ...
    init {
        ...
        KEYS.put("Escape", ControllerKey.KEY_ESCAPE)
        KEYS.put("Quote", ControllerKey.KEY_APOSTROPHE)
        KEYS.put("Semicolon", ControllerKey.KEY_SEMICOLON)
        KEYS.put("Backquote", ControllerKey.KEY_GRAVE_ACCENT)
        KEYS.put("BracketLeft", ControllerKey.KEY_BRACKET_LEFT)
        KEYS.put("BracketRight", ControllerKey.KEY_BRACKET_RIGHT)
        KEYS.put("Backslash", ControllerKey.KEY_BACKSLASH)
        KEYS.put("Slash", ControllerKey.KEY_SLASH)
        KEYS.put("Comma", ControllerKey.KEY_COMMA)
        KEYS.put("Period", ControllerKey.KEY_PERIOD)
        KEYS.put("Minus", ControllerKey.KEY_MINUS)
        KEYS.put("Equal", ControllerKey.KEY_EQUAL)
        KEYS.put("IntlBackslash", c("INTL_BACKSLASH", "Internantional Backslash"))
