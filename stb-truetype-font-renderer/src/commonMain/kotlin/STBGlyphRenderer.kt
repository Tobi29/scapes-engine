...
import net.gitout.ktbindings.stb.ttf.stbtt_GetCodepointBitmapBox
import net.gitout.ktbindings.stb.ttf.stbtt_GetCodepointHMetrics
import net.gitout.ktbindings.stb.ttf.stbtt_MakeCodepointBitmap
import net.gitout.ktbindings.stb.ttf.stbtt_ScaleForMappingEmToPixels
            ...
            for (x in 0 until tiles) {
                ...
                if (!c.isISOControl()) {
                    ...
                    stbtt_MakeCodepointBitmap(
                        font.info,
                        glyphBuffer.asDataBuffer(), glyphSize, glyphSize,
