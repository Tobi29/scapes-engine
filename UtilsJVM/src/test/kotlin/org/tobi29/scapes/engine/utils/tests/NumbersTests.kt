...
object NumbersTests : Spek({
    ...
    describe("splitting an integer into bytes") {
        val cases = listOf(
                0x00000000 to SplitInt(0x00, 0x00, 0x00, 0x00),
                0xFFFFFFFF.toInt() to SplitInt(0xFF, 0xFF, 0xFF, 0xFF),
                0x00FF00FF to SplitInt(0x00, 0xFF, 0x00, 0xFF),
                0xFF00FF00.toInt() to SplitInt(0xFF, 0x00, 0xFF, 0x00),
                0x12345678 to SplitInt(0x12, 0x34, 0x56, 0x78))
    ...
    describe("splitting an integer into bytes") {
        val cases = listOf(
                0x0000000000000000.toLong() to SplitLong(0x00, 0x00, 0x00, 0x00,
                        0x00, 0x00, 0x00, 0x00),
                -1L to SplitLong(0xFF, 0xFF, 0xFF, 0xFF,
                        0xFF, 0xFF, 0xFF, 0xFF),
                0x00FF00FF00FF00FF to SplitLong(0x00, 0xFF, 0x00, 0xFF,
                        0x00, 0xFF, 0x00, 0xFF),
                0x00FF00FF00FF0100 to SplitLong(0xFF, 0x00, 0xFF, 0x00,
                        0xFF, 0x00, 0xFF, 0x00),
                0x123456789ABCDEF0 to SplitLong(0x12, 0x34, 0x56, 0x78,
                        0x9A, 0xBC, 0xDE, 0xF0))
