...
import com.j256.simplemagik.entries.IanaEntries
...
enum class ContentType(
    ...
    init {
        this.fileExtensions = Array(fileExtensions.size) { fileExtensions[it] }
    }
    ...
    companion object {
        ...
        fun fromMimeType(mimeType: String?): ContentType {
            ...
            val type = mimeTypeMap[mimeType]
            return type ?: OTHER

        }

        /**
         * Return the type associated with the file-extension string or [.OTHER] if not found.
         */
        fun fromFileExtension(fileExtension: String): ContentType {
            // NOTE: mimeType can be null
            val type = fileExtensionMap[fileExtension.toLowerCase()]
            return type ?: OTHER
        }
    }
} // end
