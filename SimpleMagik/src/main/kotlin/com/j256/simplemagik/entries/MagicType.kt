...
object MagicType {
    ...
    private val typeMap = HashMap<String, MagicMatcher>()

    @Suppress("NOTHING_TO_INLINE")
    private inline fun register(name: String, matcher: MagicMatcher) =
        typeMap.put(name, matcher)
     ...
     */
    fun matcherfromString(typeString: String): MagicMatcher? {
