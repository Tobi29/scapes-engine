...
object NumbersTests : Spek({
    ...
    describe("splitting an integer into bytes") {
        ...
        for ((input, expected) in cases) {
            given("$input") {
                val actual =
                    input.splitToBytes { o7, o6, o5, o4, o3, o2, o1, o0 ->
                        SplitLong(
                            o7, o6, o5, o4, o3,
                            o2, o1, o0
                        )
