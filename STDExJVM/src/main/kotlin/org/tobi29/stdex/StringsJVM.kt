...
@PublishedApi
actual internal inline fun ByteArray.utf8ToStringImpl(
        offset: Int,
        size: Int
) = String(this, offset, size)

@PublishedApi
actual internal inline fun String.utf8ToArrayImpl(
...
@PublishedApi
actual internal inline fun CharArray.copyToStringImpl(
        offset: Int,
        size: Int
) = String(this, offset, size)

@PublishedApi
actual internal inline fun String.copyToArrayImpl(
